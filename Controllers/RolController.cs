        ...
        public IActionResult Get(int id)
        {
            ...
            try
            {
                using (DB_A6ED12_testmototekDBContext db = new DB_A6ED12_testmototekDBContext())
                {
                    ...
                    Role data = db.Roles.FromSqlRaw("Select * from Roles where IdRol = @Id", idSearch)
                        .FirstOrDefault();
                    resp.status = "Ok";
                    resp.message = "Success";
                    resp.data = data;
        ...
        public IActionResult Post([FromBody] Role value)
        {
            ...
            try
            {
                using (DB_A6ED12_testmototekDBContext db = new DB_A6ED12_testmototekDBContext())
                {
                    ...
                    {
                        new SqlParameter("@ROLES", value.IdRol),
                    ...
                    var data = db.Database.ExecuteSqlRaw("INSERT INTO [dbo].[ROLES] ([Nombre],[Descripcion],[FechaDeCreacion],[FechaDeModificacion]) VALUES (@NOMBRE, @DESCRIPCION, @FECHADECREACION, @FECHADEMODIFICACION)", sqlParams);
            ...
            try
            {
                using (DB_A6ED12_testmototekDBContext db = new DB_A6ED12_testmototekDBContext())
                {
                    SqlParameter[] sqlParams = new SqlParameter[]
                    {
                        ...
                        new SqlParameter("@FIELDTOCHECK", "Idrol"),
                        new SqlParameter("@TABLE", "ROLES"),
                    };
